...
const getCharts = async (req, res) => {
    ...
    if (showCharts[1]) {
        ...
        const vDesTitle = "", vDesImages = "", vDescription = [];
    ...
    if (showCharts[2]) {
        ...
        const sDesTitle = "", sDesImages = "", sDescription = [];
