...
const reportSchema = new mongoose.Schema({
    ...
    agent_scheduled_updates1: { type: String, default: "Active Update" },
    ...
    suspicious_Connection1: { type: String, default: 'Enabled' },
    suspicious_Connection2: { type: String, default: 'Block' },
    suspicious_Connection3: { type: String, default: 'Enabled' },
    suspicious_Connection4: { type: String, default: 'Enabled' },
    suspicious_Connection5: { type: String, default: '"Block"' },
    suspicious_Connection6: { type: String, default: 'Enabled' },

    vulnerability_protection: { type: String, default: 'Enabled' },
    vp_mode: { type: String, default: 'Inline' },
    vpProfile: { type: String, default: "Recommended" },
    ...
    web_reputation3: { type: String, default: 'Disabled' },
    application_control1: { type: String, default: 'Enabled' },
    application_control2: { type: String, default: "Allow Mode" },
    firewall: { type: String, default: 'Enabled' },
    agent_self_protection1: { type: String, default: 'Enabled' },
    agent_self_protection2: { type: String, default: 'Enabled' },
    agent_self_protection3: { type: String, default: 'Enabled' },
    agent_self_protection4: { type: String, default: 'All Component' },
    ...
    tab53SC1: { type: String, default: "images/tab1.png" },
    tab53SC2: { type: String, default: "images/tab1.png" },
    tab53SC3: { type: String, default: "images/tab1.png" },
    tab53SC4: { type: String, default: "images/tab1.png" },

    tab54: { type: String, default: "images/tab1.png" },
    tab54WR: { type: String, default: "images/tab1.png" },
    tab55: { type: String, default: "images/tab1.png" },
    tab56PS1: { type: String, default: "images/tab1.png" },
    tab56PS2: { type: String, default: "images/tab1.png" },
    tab56PS3: { type: String, default: "images/tab1.png" },
    tab56PS4: { type: String, default: "images/tab1.png" },
    tab59: { type: String, default: "images/tab1.png" },
    tabVP: { type: String, default: "images/tab1.png" },
    tabVP1: { type: String, default: "images/tab1.png" },
