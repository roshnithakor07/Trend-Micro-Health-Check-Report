...
function Po2Logic() {
    const { getPolicyData, getReportData } = Endpoints();
    const {
    ...
    const getReportDocument = async () => {
        await axios({
            ...
            .then((res) => {
                setSummarySenPolicy2Arr(JSON.parse(res.data[0].eSummaryPolicyOverview1))
                setReqSummarySenPolicy2Arr(JSON.parse(res.data[0].allPolicyTwoReq))
        ...
        await axios({
            ...
            .then((res) => {
                for (const i of policyOneImg) {
                    myPo2ImgData[i] = res.data[0][i];
                    setPolicyTwoName(res.data[0].OverviewPolicyName1);
                }
    ...
    const checkPolicyOverview1 = () => {
        ...
        if (checkPolicyOverviewES1 >= 1) {
            ...
            const eSummaryPolicyOverview1 = `Policy is not configured as per the Trend Micro best practice.`
