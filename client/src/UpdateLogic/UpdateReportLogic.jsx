...
const UpdateReportLogic = () => {
    ...
    updateDocumentData.report_date = `${date.toLocaleDateString()}  ${date.toLocaleTimeString()}`
    ...
    return { visible, updateDocumentData, myReportData, handleType, loadFile, handleChange, handleUpdateReport }
}
