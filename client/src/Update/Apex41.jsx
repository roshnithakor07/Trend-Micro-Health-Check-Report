                    ...
                    {visible ? (
                        ...
                        <div className="container10">
                            <p>
                                ...
                                security products and services throughout the network. <br />
                                <br />
                                Apex one SaaS provisioned <strong>{updateDocumentData.cName}</strong> to manage a
                                total of{" "}
                                <input
                                    type="number"
                                    name="total_service"
                                    value={updateDocumentData.total_service || ""}
                    ...
                    <table className="con5 table1" id="documentV">
                        ...
                        <tbody id="table1">
                            ...
                            {visible && (
                                <>
                                    ...
                                    <tr className="con5" id="hea1">
                                        ...
                                        <td className="con5">
                                            <input
                                                ...
                                                value={updateDocumentData.memory1 || ""}
                                                id="memory1"
                                                name="memory1"
                                                style={{
                                                    width: "50px",
                                        ...
                                        <td className="con5">
                                            <input
                                                ...
                                                name="memory2"
                                                id="memory2"
                                                value={updateDocumentData.memory2 || ""}
                                                onChange={(e) => {
                                                    handleChange(e);
                                                    handleMemory(e);
                                                }}
                                        ...
                                        <td className="con5" style={{ textAlign: "center" }}>
                                            <img src={`/${updateDocumentData.apexmemory}`} id="sep8880" alt="" />
                                        </td>
                                    </tr>
                                    <tr className="con5" id="hea2">
                                        ...
                                        >
                                            <img src={`/${updateDocumentData.apeximgsos}`} id="img" alt="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>CPU</td>
                                    ...
                                    <tr className="con5" id="hea3">
                                        ...
                                        <td className="con5"></td>
                                        <td className="con5">
                                            <input type="text" name="ip1" value={updateDocumentData.ip1 || ""} onChange={handleChange} />
                                        </td>
                                        <td className="con5" style={{ textAlign: "center" }}>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                id="version1"
                                                name="version1"
                                                value={updateDocumentData.version1 || ""}
                                                onChange={(e) => {
                                                    handleChange(e);
                                                    handleVersions(e);
                                                }}
                                        ...
                                        <td>
                                            <input
                                                type="number"
                                                id="version2"
                                                value={updateDocumentData.version2 || ""}
                                                onChange={(e) => {
                                                    handleVersions(e);
                                                    handleChange(e);
                                                }}
                                        ...
                                        <td style={{ textAlign: "center" }}>
                                            <img src={`/${updateDocumentData.apeximgversions}`} id="apex1sep60" alt="" />
                                        </td>
                                    </tr>
                                        ...
                                        <td className="con5">
                                            <div>
                                                <select
                                                    ...
                                                    value={updateDocumentData.agent_management_tree || ""}
                                                    onChange={handleChange}
                                                >
                            ...
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <input
                                        ...
                                        value={moment(updateDocumentData.license_date1).format("YYYY-MM-DD") || ""}
                                        onChange={(e) => {
                                            zeroFunction(e);
                                            handleChange(e);
                                        }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximglicense_date}`} alt="" id="sep0" />
                                </td>
                            </tr>
                            ...
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    ...
                                    <input
                                        ...
                                        value={updateDocumentData.total_purchased_licensed || ""}
                                        onChange={(e) => {
                                            oneFunction(e);
                                            handleChange(e);
                                        }}
                                ...
                                <td className="con5">
                                    <input
                                        ...
                                        value={updateDocumentData.total_deployed_licensed || ""}
                                        onChange={(e) => {
                                            oneFunction(e);
                                            handleChange(e);
                                        }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgDeployed_Agents}`} id="sep1" alt="" />
                                </td>
                            </tr>
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        <select
                                            ...
                                            value={updateDocumentData.certified_safe_software_service || ""}
                                            onChange={(e) => {
                                                twoFunction(e);
                                                handleChange(e);
                                            }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgCertified_Safe_Software_Service}`} id="sep2" alt="" />
                                </td>
                            </tr>
                            ...
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        <select
                                            ...
                                            value={updateDocumentData.apex_central_integration || ""}
                                            onChange={(e) => {
                                                threeFunction(e);
                                                handleChange(e);
                                            }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgapex_central_integration}`} id="sep3" alt="" />
                                </td>
                            </tr>
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        <select
                                            ...
                                            value={updateDocumentData.global_agents_settings1 || ""}
                                            onChange={(e) => {
                                                fourFunction(e);
                                                handleChange(e);
                                            }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgglobal_agents_settings1}`} id="sep4" alt="" />
                                </td>
                            </tr>
                            <tr className="con5">
                                <td className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            value={updateDocumentData.global_agents_settings2 || ""}
                                            onChange={(e) => {
                                                fiveFunction(e);
                                                handleChange(e);
                                            }}
                                        ...
                                        <select
                                            ...
                                            value={updateDocumentData.global_agents_settings3 || ""}
                                            onChange={(e) => {
                                                fiveFunction(e);
                                                handleChange(e);
                                            }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgglobal_agents_settings2}`} id="sep5" alt="" />
                                </td>
                            </tr>
                            {visible && (
                                <tr className="con5">
                                    ...
                                    <td className="con5">
                                        <div>
                                            <select
                                                ...
                                                value={updateDocumentData.global_agents_settings4 || ""}
                                                onChange={(e) => {
                                                    fiveFunction1(e);
                                                    handleChange(e);
                                                }}
                                    ...
                                    <td className="con5" style={{ textAlign: "center" }}>
                                        <img src={`/${updateDocumentData.apeximgglobal_agents_settings3}`} id="sep5GA" alt="" />
                                    </td>
                                </tr>
                            )}
                            ...
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div id="AgentSU">
                                        <select
                                            ...
                                            value={updateDocumentData.agent_scheduled_updates || ""}
                                            onChange={(e) => {
                                                sixFunction(e);
                                                handleChange(e);
                                            }}
                                        ...
                                        <span id="time">
                                            <select
                                                ...
                                                value={updateDocumentData.agent_scheduled_updates_option || ""}
                                                onChange={(e) => {
                                                    sixFunction(e);
                                                    handleChange(e);
                                                }}
                                            ...
                                            <input
                                                ...
                                                value={updateDocumentData.agent_scheduled_updates_daily || ""}
                                                onChange={handleChange}
                                            />{" "}
                                            Time Period-{" "}
                                            <input
                                                ...
                                                name="timePeriod"
                                                id="pwd"
                                                value={updateDocumentData.timePeriod || ""}
                                                onChange={handleChange}
                                            />
                                        </span>
                                    </div>
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgagent_scheduled_updates}`} id="sep6" alt="" />
                                </td>
                            </tr>
                            <tr className="con5">
                                ...
                                <td className="con5" id="uptodate">
                                    ...
                                    <input
                                        ...
                                        style={{ width: "25%" }}
                                        value={updateDocumentData.patterns_update_status_uptodate || ""}
                                        onChange={(e) => {
                                            handleChange(e);
                                            superman(e);
                                        }}
                                    ...
                                    <input
                                        ...
                                        name="outdated"
                                        style={{ width: "25%" }}
                                        value={updateDocumentData.outdated || ""}
                                        onChange={(e) => {
                                            handleChange(e);
                                            superman(e);
                                        }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgsuperman}` || ""} id="super" alt="" />
                                </td>
                            </tr>
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        <select
                                            ...
                                            onChange={handleChange}
                                            value={updateDocumentData.smart_portection_server || ""}
                                        >
                            ...
                            <tr className="con5">
                                ...
                                <td className="con5">
                                    <div>
                                        <select
                                            id="8"
                                            name="notification"
                                            value={updateDocumentData.notification || ""}
                                            onChange={(e) => {
                                                sevenFunction(e);
                                                handleChange(e);
                                            }}
                                ...
                                <td className="con5" style={{ textAlign: "center" }}>
                                    <img src={`/${updateDocumentData.apeximgnotification}`} id="sep7" alt="" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
