...
export default function Virus(props) {
    ...
    function handleSubmit() {
        ...
        if (columnsNames === vm[0]) {
            ...
            myChartData['virus'] = JSON.stringify(x)
            myChartData['virus_count'] = JSON.stringify(y1)
    ...
    const handleCharts = () => {
        ...
        const getProductById = async (e) => {
            try {
                ...
                await axios.post(virusApi, myChartData);
    ...
    return (
        <>
            <div className="virus-section common-chart" id='virus'>
                ...
                <span id="chartFirstLine1"><input style={inputStyle} value={chartFirstLine} onChange={(e) => { setChartFirstLine(e.target.value) }} name="chartFirstLine" type="text" id="vmChartFirstLine" /></span>
