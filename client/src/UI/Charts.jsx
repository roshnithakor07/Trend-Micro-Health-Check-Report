    ...
    <>
      ...
      <div className="chart-section">
        ...
        <div className="all-Chart-section">
          ...
          {showCharts[0] && (<Ag chartTitle={agTitle} showCharts={showCharts} />)}
          {showCharts[1] && (<Virus chartTitle={vTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[2] && (<Spyware chartTitle={spTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[3] && (<WR chartTitle={wrTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[4] && (<IP chartTitle={ipTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[5] && (<DC chartTitle={dcTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[6] && (<CC chartTitle={ccTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[7] && (<BM chartTitle={bmTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
          {showCharts[8] && (<SmartScan chartTitle={ssTitle} logDays={logDays} logDuration={logDuration} logCollectionDate={formattedDate} />)}
